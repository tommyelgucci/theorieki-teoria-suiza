...
export const VKU_CARDS = [
  ...
  { id: 'v15', front: { de: 'Warum mehr Abstand hinter einem Lastwagen?', es: '¿Por qué más distancia detrás de un camión?', fr: 'Pourquoi plus de distance derrière un camion ?', it: 'Perché più distanza dietro un camion?', en: 'Why more distance behind a lorry?', pt: 'Porquê mais distância atrás de um camião?' }, back: { de: 'Eingeschränkte Sicht + du bist oft in seinem toten Winkel', es: 'Visión reducida y sueles estar en su ángulo muerto', fr: 'Vue réduite + tu es souvent dans son angle mort', it: 'Vista limitata + sei spesso nel suo angolo cieco', en: 'Reduced view + you are often in its blind spot', pt: 'Visão reduzida + estás muitas vezes no seu ângulo morto' } },
  { id: 'v16', front: { de: 'Dichter Nebel: erste Massnahme?', es: 'Niebla densa: ¿primera medida?', fr: 'Brouillard dense : première mesure ?', it: 'Nebbia fitta: prima misura?', en: 'Dense fog: first action?', pt: 'Nevoeiro cerrado: primeira medida?' }, back: { de: 'Tempo der Sichtweite anpassen + Nebelschlussleuchte', es: 'Adaptar la velocidad a la visibilidad + luz antiniebla trasera', fr: 'Adapter la vitesse à la visibilité + feu de brouillard arrière', it: 'Adattare la velocità alla visibilità + luce fendinebbia posteriore', en: 'Match speed to visibility + rear fog light', pt: 'Ajustar a velocidade à visibilidade + farolim de nevoeiro traseiro' } },
  { id: 'v17', front: { de: 'Warum vereisen Brücken zuerst?', es: '¿Por qué se hielan antes los puentes?', fr: 'Pourquoi les ponts gèlent-ils en premier ?', it: 'Perché i ponti gelano per primi?', en: 'Why do bridges ice over first?', pt: 'Porque é que as pontes gelam primeiro?' }, back: { de: 'Sie kühlen von oben UND unten gleichzeitig aus', es: 'Se enfrían por arriba Y por abajo a la vez', fr: 'Ils refroidissent par le dessus ET le dessous en même temps', it: 'Si raffreddano da sopra E da sotto contemporaneamente', en: 'They cool from above AND below at the same time', pt: 'Arrefecem por cima E por baixo ao mesmo tempo' } },
  { id: 'v18', front: { de: 'Müdigkeit + Restalkohol = ?', es: 'Cansancio + alcohol residual = ¿?', fr: 'Fatigue + alcool résiduel = ?', it: 'Stanchezza + alcol residuo = ?', en: 'Tiredness + residual alcohol = ?', pt: 'Cansaço + álcool residual = ?' }, back: { de: 'Verstärken sich gegenseitig – Reaktion verschlechtert sich stark', es: 'Se potencian mutuamente: la reacción empeora mucho', fr: 'Se renforcent mutuellement – la réaction se dégrade fortement', it: 'Si potenziano a vicenda – la reazione peggiora molto', en: 'Reinforce each other – reaction worsens sharply', pt: 'Reforçam-se mutuamente – a reação piora muito' } },
]
...
export const VKU_QUESTIONS = [
  ...
  },
  {
    ...
    points: 1,
    question: {
      de: 'Du fährst müde und hast am Vorabend Alkohol getrunken, der noch nicht ganz abgebaut ist. Wie wirkt sich das kombiniert aus?',
      es: 'Conduces cansado y anoche bebiste alcohol que aún no se ha eliminado del todo. ¿Cómo actúa esa combinación?',
      fr: 'Tu conduis fatigué et as bu de l’alcool la veille, pas encore totalement éliminé. Quel est l’effet combiné ?',
      it: 'Guidi stanco e la sera prima hai bevuto alcol non ancora del tutto smaltito. Come agisce la combinazione?',
      en: 'You drive tired and drank alcohol the evening before that has not fully cleared. What is the combined effect?',
      pt: 'Conduzes cansado e na véspera bebeste álcool que ainda não foi totalmente eliminado. Qual é o efeito combinado?',
    },
    options: [
      { id: 'a', text: { de: 'Müdigkeit und Restalkohol verstärken sich gegenseitig – die Reaktionszeit verschlechtert sich überproportional', es: 'El cansancio y el alcohol residual se potencian mutuamente: la reacción empeora de forma desproporcionada', fr: 'La fatigue et l’alcool résiduel se renforcent mutuellement – la réaction se dégrade de façon disproportionnée', it: 'Stanchezza e alcol residuo si potenziano a vicenda – la reazione peggiora in modo sproporzionato', en: 'Tiredness and residual alcohol reinforce each other – reaction time worsens disproportionately', pt: 'O cansaço e o álcool residual reforçam-se mutuamente – a reação piora de forma desproporcional' }, correct: true },
      { id: 'b', text: { de: 'Müdigkeit und Alkohol heben sich gegenseitig auf', es: 'El cansancio y el alcohol se anulan mutuamente', fr: 'Fatigue et alcool s’annulent mutuellement', it: 'Stanchezza e alcol si annullano a vicenda', en: 'Tiredness and alcohol cancel each other out', pt: 'O cansaço e o álcool anulam-se mutuamente' }, correct: false },
      { id: 'c', text: { de: 'Nur der Alkohol zählt, Müdigkeit spielt keine Rolle mehr', es: 'Solo cuenta el alcohol, el cansancio ya no importa', fr: 'Seul l’alcool compte, la fatigue n’a plus d’importance', it: 'Conta solo l’alcol, la stanchezza non ha più importanza', en: 'Only the alcohol counts, tiredness no longer matters', pt: 'Só o álcool conta, o cansaço já não importa' }, correct: false },
    ],
    explanation: {
      de: 'Müdigkeit und Restalkohol verstärken sich gegenseitig; die Kombination ist gefährlicher als jeder Faktor allein und wird oft unterschätzt.',
      es: 'El cansancio y el alcohol residual se potencian entre sí; la combinación es más peligrosa que cada factor por separado y suele subestimarse.',
      fr: 'La fatigue et l’alcool résiduel se renforcent mutuellement ; la combinaison est plus dangereuse que chaque facteur seul et souvent sous-estimée.',
      it: 'Stanchezza e alcol residuo si potenziano a vicenda; la combinazione è più pericolosa di ogni singolo fattore e viene spesso sottovalutata.',
      en: 'Tiredness and residual alcohol reinforce each other; the combination is more dangerous than either factor alone and is often underestimated.',
      pt: 'O cansaço e o álcool residual reforçam-se mutuamente; a combinação é mais perigosa do que cada fator isolado e é muitas vezes subestimada.',
    },
  },
  {
    id: 'vk14',
    ...
    points: 1,
    question: {
      de: 'Du fährst hinter einem Lastwagen. Warum ist ein grösserer Abstand hier besonders wichtig?',
      es: 'Vas detrás de un camión. ¿Por qué es especialmente importante aquí una distancia mayor?',
      fr: 'Tu roules derrière un camion. Pourquoi une plus grande distance est-elle ici particulièrement importante ?',
      it: 'Viaggi dietro un camion. Perché qui è particolarmente importante una distanza maggiore?',
      en: 'You are driving behind a lorry. Why is a bigger distance especially important here?',
      pt: 'Segues atrás de um camião. Porque é especialmente importante aqui uma distância maior?',
    },
    options: [
      { id: 'a', text: { de: 'Weil deine Sicht nach vorne eingeschränkt ist und der Lastwagenfahrer dich in seinem toten Winkel eventuell nicht sieht', es: 'Porque tu visión hacia delante está limitada y el camionero puede no verte en su ángulo muerto', fr: 'Parce que ta vue vers l’avant est réduite et que le chauffeur peut ne pas te voir dans son angle mort', it: 'Perché la tua visuale in avanti è limitata e l’autista del camion potrebbe non vederti nel suo angolo cieco', en: 'Because your view ahead is limited and the lorry driver may not see you in their blind spot', pt: 'Porque a tua visão à frente fica limitada e o condutor do camião pode não te ver no ângulo morto' }, correct: true },
      { id: 'b', text: { de: 'Weil Lastwagen generell schneller bremsen als Autos', es: 'Porque los camiones siempre frenan más rápido que los coches', fr: 'Parce que les camions freinent en général plus vite que les voitures', it: 'Perché i camion in genere frenano più velocemente delle auto', en: 'Because lorries generally brake faster than cars', pt: 'Porque os camiões em geral travam mais depressa do que os carros' }, correct: false },
      { id: 'c', text: { de: 'Weil das Gesetz bei Lastwagen einen doppelten Mindestabstand vorschreibt', es: 'Porque la ley exige el doble de distancia mínima con los camiones', fr: 'Parce que la loi impose une distance minimale double derrière les camions', it: 'Perché la legge prescrive dietro i camion una distanza minima doppia', en: 'Because the law prescribes double the minimum distance behind lorries', pt: 'Porque a lei prescreve o dobro da distância mínima atrás de camiões' }, correct: false },
    ],
    explanation: {
      de: 'Hinter Lastwagen ist die Sicht auf den Verkehr eingeschränkt und du befindest dich oft im toten Winkel des Fahrers – mehr Abstand schafft Übersicht und Reaktionszeit.',
      es: 'Detrás de un camión la visión del tráfico se reduce y sueles estar en el ángulo muerto del conductor; más distancia da visión y tiempo de reacción.',
      fr: 'Derrière un camion, la vue sur le trafic est réduite et tu te trouves souvent dans l’angle mort du chauffeur – plus de distance offre visibilité et temps de réaction.',
      it: 'Dietro un camion la visuale sul traffico è limitata e ti trovi spesso nell’angolo cieco dell’autista – più distanza dà visuale e tempo di reazione.',
      en: 'Behind a lorry, your view of traffic is limited and you are often in the driver’s blind spot – more distance provides overview and reaction time.',
      pt: 'Atrás de um camião, a visão do trânsito fica limitada e estás muitas vezes no ângulo morto do condutor – mais distância dá visão e tempo de reação.',
    },
  },
  {
    id: 'vk15',
    ...
    points: 1,
    question: {
      de: 'Dichter Nebel, Sichtweite unter 50 m. Was ist taktisch richtig?',
      es: 'Niebla densa, visibilidad inferior a 50 m. ¿Qué es lo táctico correcto?',
      fr: 'Brouillard dense, visibilité inférieure à 50 m. Quelle est la bonne tactique ?',
      it: 'Nebbia fitta, visibilità inferiore a 50 m. Qual è la tattica corretta?',
      en: 'Dense fog, visibility under 50 m. What is tactically correct?',
      pt: 'Nevoeiro cerrado, visibilidade inferior a 50 m. O que é taticamente correto?',
    },
    options: [
      { id: 'a', text: { de: 'Tempo deutlich reduzieren und, wo vorhanden, die Nebelschlussleuchte einschalten', es: 'Reducir claramente la velocidad y encender la luz antiniebla trasera si la hay', fr: 'Réduire nettement la vitesse et allumer le feu de brouillard arrière si disponible', it: 'Ridurre nettamente la velocità e accendere, se presente, la luce fendinebbia posteriore', en: 'Reduce speed considerably and switch on the rear fog light if fitted', pt: 'Reduzir claramente a velocidade e ligar o farolim de nevoeiro traseiro, se existir' }, correct: true },
      { id: 'b', text: { de: 'Fernlicht einschalten, um weiter sehen zu können', es: 'Poner las luces largas para ver más lejos', fr: 'Allumer les feux de route pour voir plus loin', it: 'Accendere gli abbaglianti per vedere più lontano', en: 'Switch on high beams to see further', pt: 'Ligar os máximos para ver mais longe' }, correct: false },
      { id: 'c', text: { de: 'Dicht auf das Rücklicht des Vordermanns auffahren, um die Orientierung zu behalten', es: 'Pegarte a la luz trasera del coche de delante para no perder la orientación', fr: 'Coller au feu arrière du véhicule qui précède pour garder l’orientation', it: 'Restare incollato al fanale posteriore del veicolo davanti per non perdere l’orientamento', en: 'Tailgate the car in front’s tail light to keep your bearings', pt: 'Colar-te à luz traseira do carro da frente para não perderes a orientação' }, correct: false },
    ],
    explanation: {
      de: 'Bei Nebel Tempo der Sichtweite anpassen und Nebelschlussleuchte nutzen; Fernlicht blendet durch die Reflexion in den Tröpfchen noch mehr, und dichtes Auffahren ist bei einer Notbremsung lebensgefährlich.',
      es: 'Con niebla, adapta la velocidad a la visibilidad y usa la luz antiniebla trasera; las largas deslumbran aún más por el reflejo en las gotas, y pegarse al de delante es mortal si frena de golpe.',
      fr: 'Par brouillard, adapte la vitesse à la visibilité et utilise le feu de brouillard arrière ; les feux de route éblouissent davantage par réflexion sur les gouttelettes, et coller au véhicule précédent est mortel en cas de freinage d’urgence.',
      it: 'Con la nebbia adatta la velocità alla visibilità e usa la luce fendinebbia posteriore; gli abbaglianti accecano ancora di più per il riflesso nelle goccioline, e restare incollati è mortale in caso di frenata d’emergenza.',
      en: 'In fog, match your speed to visibility and use the rear fog light; high beams glare even more due to reflection off droplets, and tailgating is deadly in an emergency stop.',
      pt: 'Com nevoeiro, ajusta a velocidade à visibilidade e usa o farolim de nevoeiro traseiro; os máximos encandeiam ainda mais por reflexo nas gotículas, e colar-te ao da frente é mortal numa travagem de emergência.',
    },
  },
  {
    id: 'vk16',
    ...
    points: 1,
    question: {
      de: 'Waldrand, Dämmerung, Signal «Wildwechsel». Was ist die richtige Taktik?',
      es: 'Borde del bosque, atardecer, señal de «paso de animales». ¿Cuál es la táctica correcta?',
      fr: 'Lisière de forêt, crépuscule, signal « passage de gibier ». Quelle est la bonne tactique ?',
      it: 'Margine del bosco, crepuscolo, segnale «attraversamento selvaggina». Qual è la tattica corretta?',
      en: 'Forest edge, dusk, "wildlife crossing" sign. What is the correct tactic?',
      pt: 'Orla da floresta, anoitecer, sinal de «passagem de animais». Qual é a tática correta?',
    },
    options: [
      { id: 'a', text: { de: 'Tempo reduzieren, Fernlicht meiden wenn Gegenverkehr fehlt, und aufmerksam beobachten – Tiere kommen oft in Gruppen', es: 'Reducir la velocidad, evitar las largas si no hay tráfico en sentido contrario y observar con atención: los animales suelen ir en grupo', fr: 'Réduire la vitesse, éviter les feux de route en l’absence de trafic en sens inverse, et observer attentivement – les animaux viennent souvent en groupe', it: 'Ridurre la velocità, evitare gli abbaglianti in assenza di traffico opposto e osservare con attenzione – gli animali arrivano spesso in gruppo', en: 'Reduce speed, avoid high beams when there is no oncoming traffic, and watch closely – animals often come in groups', pt: 'Reduzir a velocidade, evitar os máximos quando não há trânsito em sentido contrário, e observar com atenção – os animais costumam vir em grupo' }, correct: true },
      { id: 'b', text: { de: 'Normal weiterfahren, das Signal ist nur eine allgemeine Warnung ohne praktische Bedeutung', es: 'Seguir con normalidad, la señal es solo una advertencia general sin valor práctico', fr: 'Continuer normalement, le signal n’est qu’un avertissement général sans portée pratique', it: 'Proseguire normalmente, il segnale è solo un avviso generale senza rilevanza pratica', en: 'Keep driving normally, the sign is just a general warning with no practical meaning', pt: 'Continuar normalmente, o sinal é só um aviso geral sem valor prático' }, correct: false },
      { id: 'c', text: { de: 'Hupen, damit die Tiere flüchten', es: 'Tocar el claxon para que los animales huyan', fr: 'Klaxonner pour faire fuir les animaux', it: 'Suonare il clacson perché gli animali fuggano', en: 'Honk the horn so the animals flee', pt: 'Buzinar para os animais fugirem' }, correct: false },
    ],
    explanation: {
      de: 'An Wildwechselstellen kann jederzeit ein Tier die Strasse queren; oft folgen weitere Tiere derselben Gruppe nach. Tempo reduzieren, Umfeld beobachten und bremsbereit bleiben.',
      es: 'En zonas de paso de animales, un animal puede cruzar la calzada en cualquier momento; a menudo le siguen más del mismo grupo. Reduce la velocidad, observa el entorno y mantente listo para frenar.',
      fr: 'Aux endroits de passage de gibier, un animal peut traverser à tout moment ; d’autres du même groupe suivent souvent. Réduis la vitesse, observe les abords et reste prêt à freiner.',
      it: 'Nei punti di attraversamento selvaggina, un animale può attraversare in qualsiasi momento; spesso ne seguono altri dello stesso gruppo. Riduci la velocità, osserva i dintorni e resta pronto a frenare.',
      en: 'At wildlife crossing points, an animal can cross the road at any time; others from the same group often follow. Reduce speed, watch the surroundings and stay ready to brake.',
      pt: 'Nos pontos de passagem de animais, um animal pode atravessar a estrada a qualquer momento; muitas vezes seguem-se outros do mesmo grupo. Reduz a velocidade, observa os arredores e mantém-te pronto para travar.',
    },
  },
  {
    id: 'vk17',
    ...
    points: 1,
    question: {
      de: 'Warum sind Brücken bei Frost besonders gefährlich?',
      es: '¿Por qué son especialmente peligrosos los puentes cuando hiela?',
      fr: 'Pourquoi les ponts sont-ils particulièrement dangereux par temps de gel ?',
      it: 'Perché i ponti sono particolarmente pericolosi con il gelo?',
      en: 'Why are bridges especially dangerous in frosty weather?',
      pt: 'Porque é que as pontes são especialmente perigosas com geada?',
    },
    options: [
      { id: 'a', text: { de: 'Sie kühlen von oben und unten gleichzeitig aus und vereisen deshalb früher als die übrige Strasse', es: 'Se enfrían por arriba y por abajo a la vez, por lo que se hielan antes que el resto de la calzada', fr: 'Ils refroidissent par le dessus et le dessous en même temps et gèlent donc avant le reste de la route', it: 'Si raffreddano da sopra e da sotto contemporaneamente e quindi gelano prima del resto della strada', en: 'They cool from above and below at the same time, so they ice over before the rest of the road', pt: 'Arrefecem por cima e por baixo ao mesmo tempo, por isso gelam antes do resto da estrada' }, correct: true },
      { id: 'b', text: { de: 'Brücken sind immer breiter, was das Fahren erschwert', es: 'Los puentes siempre son más anchos, lo que dificulta conducir', fr: 'Les ponts sont toujours plus larges, ce qui complique la conduite', it: 'I ponti sono sempre più larghi, il che rende più difficile la guida', en: 'Bridges are always wider, which makes driving harder', pt: 'As pontes são sempre mais largas, o que dificulta a condução' }, correct: false },
      { id: 'c', text: { de: 'Auf Brücken gilt grundsätzlich Tempo 30', es: 'En los puentes rige siempre el límite de 30', fr: 'Sur les ponts, la limite de 30 s’applique toujours', it: 'Sui ponti vige sempre il limite di 30', en: 'A 30 km/h limit always applies on bridges', pt: 'Nas pontes vigora sempre o limite de 30' }, correct: false },
    ],
    explanation: {
      de: 'Brücken verlieren Wärme nach oben UND unten (kein wärmender Untergrund darunter) und frieren deshalb oft schon zu, wenn die Strasse daneben noch trocken ist – auch bei Temperaturen knapp über 0 °C.',
      es: 'Los puentes pierden calor por arriba Y por abajo (no hay terreno debajo que los caliente) y por eso suelen helarse antes de que la calzada adyacente lo haga, incluso con temperaturas algo superiores a 0 °C.',
      fr: 'Les ponts perdent de la chaleur par le dessus ET le dessous (pas de sol chauffant en dessous) et gèlent donc souvent déjà quand la route voisine est encore sèche, même à des températures juste au-dessus de 0 °C.',
      it: 'I ponti perdono calore da sopra E da sotto (nessun terreno caldo sottostante) e quindi spesso gelano già quando la strada accanto è ancora asciutta, anche con temperature appena sopra 0 °C.',
      en: 'Bridges lose heat both above AND below (no warming ground underneath) and so often ice over while the road nearby is still dry, even at temperatures just above 0 °C.',
      pt: 'As pontes perdem calor por cima E por baixo (não há solo a aquecer por baixo) e por isso gelam muitas vezes quando a estrada ao lado ainda está seca, mesmo com temperaturas pouco acima de 0 °C.',
    },
  },
  {
    id: 'vk18',
    ...
    points: 1,
    question: {
      de: 'Du fährst um 07:50 Uhr an einer Schule mit vielen Kindern auf dem Trottoir vorbei. Worauf bereitest du dich vor?',
      es: 'Pasas a las 07:50 junto a una escuela con muchos niños en la acera. ¿Para qué te preparas?',
      fr: 'Tu passes à 07h50 devant une école avec beaucoup d’enfants sur le trottoir. À quoi te prépares-tu ?',
      it: 'Passi alle 07:50 davanti a una scuola con molti bambini sul marciapiede. A cosa ti prepari?',
      en: 'You drive past a school at 07:50 with many children on the pavement. What do you prepare for?',
      pt: 'Passas às 07h50 junto a uma escola com muitas crianças no passeio. Para que te preparas?',
    },
    options: [
      { id: 'a', text: { de: 'Auf plötzliches, unüberlegtes Betreten der Fahrbahn – Tempo reduzieren und bremsbereit sein', es: 'Para que alguien invada la calzada de repente y sin pensar: reducir la velocidad y estar listo para frenar', fr: 'À une incursion soudaine et irréfléchie sur la chaussée – réduire la vitesse et rester prêt à freiner', it: 'A un’invasione improvvisa e sconsiderata della carreggiata – ridurre la velocità e restare pronto a frenare', en: 'A sudden, thoughtless step onto the road – reduce speed and stay ready to brake', pt: 'A uma invasão súbita e impensada da faixa de rodagem – reduzir a velocidade e estar pronto para travar' }, correct: true },
      { id: 'b', text: { de: 'Auf gar nichts Besonderes, Kinder verhalten sich immer vorsichtig', es: 'Para nada especial, los niños siempre se comportan con cuidado', fr: 'À rien de particulier, les enfants sont toujours prudents', it: 'A niente di particolare, i bambini si comportano sempre con prudenza', en: 'For nothing special, children always behave carefully', pt: 'Para nada de especial, as crianças comportam-se sempre com cuidado' }, correct: false },
      { id: 'c', text: { de: 'Nur auf das Verhalten der Erwachsenen, die die Kinder begleiten', es: 'Solo para el comportamiento de los adultos que acompañan a los niños', fr: 'Seulement au comportement des adultes qui accompagnent les enfants', it: 'Solo al comportamento degli adulti che accompagnano i bambini', en: 'Only for the behaviour of the adults accompanying the children', pt: 'Só para o comportamento dos adultos que acompanham as crianças' }, correct: false },
    ],
    explanation: {
      de: 'Kinder handeln impulsiv und schätzen Geschwindigkeiten und Distanzen falsch ein; in der Nähe von Schulen gehören reduziertes Tempo und erhöhte Aufmerksamkeit zur Grundtaktik.',
      es: 'Los niños actúan por impulso y calculan mal velocidades y distancias; cerca de escuelas, reducir la velocidad y estar muy atento forma parte de la táctica básica.',
      fr: 'Les enfants agissent par impulsion et évaluent mal vitesses et distances ; près des écoles, vitesse réduite et vigilance accrue font partie de la tactique de base.',
      it: 'I bambini agiscono d’impulso e valutano male velocità e distanze; vicino alle scuole, velocità ridotta e attenzione elevata fanno parte della tattica di base.',
      en: 'Children act on impulse and misjudge speeds and distances; near schools, reduced speed and heightened attention are basic tactics.',
      pt: 'As crianças agem por impulso e avaliam mal velocidades e distâncias; perto de escolas, velocidade reduzida e atenção redobrada fazem parte da tática básica.',
    },
  },
]
