...
- **Modo examen**: simulación con preguntas aleatorias, temporizador, puntos de penalización y repaso de errores al final. Con el banco actual (350 preguntas para categoría B; 362 para A, que suma 12 propias) ya alcanza el formato real: 50 preguntas, máx. 15 puntos, 45 min; con un banco menor escala proporcionalmente
...
- **Maniobras animadas**: animaciones SVG limpias en vista cenital (estilo "vídeo explicativo") con coche animado, indicador de volante, intermitentes, marcha atrás y captions paso a paso, bilingües. 11 maniobras de categoría B: aparcar en paralelo, en perpendicular y de frente, girar a la izquierda con Einspuren, tramo largo marcha atrás, cambio de sentido en 3 tiempos, parada en el STOP, frenada de emergencia (Vollbremsung), dónde parar ("Anhalten"), la regla de los 2 segundos y elegir la salida correcta en un kreisel (4 variantes, 1ª a 4ª salida)
...
- **Primeros auxilios (Nothelfer)**: módulo de repaso del Nothelferkurs obligatorio (temario en `src/data/firstaid.js`): 10 temas de lectura (números de emergencia, asegurar el accidente, GABI, posición lateral, RCP 30:2 y DEA, hemorragias/shock, infarto/ictus/quemaduras, obligaciones legales, atragantamiento, fracturas y esguinces), 34 flashcards con progreso persistente y quiz de 10 preguntas (elegidas de un banco de 24) con feedback. No sustituye el curso oficial presencial.
